...
fn main() {
    ...
    let mut sweden = Country::new("Finland", &10000000, &200000, &vec![], &false);
    let mut norway = Country::new("Finland", &5500000, &100000, &vec![], &false);
    let mut denmark = Country::new("Finland", &6000000, &50000, &vec![], &false);
