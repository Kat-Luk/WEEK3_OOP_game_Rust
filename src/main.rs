...
use std::io;
fn main() {
    let mut finland = Country::new(<&str>::from("Finland"), &5600000, &900000, &vec![], &false);
    let mut sweden = Country::new(<&str>::from("Sweden"), &10000000, &200000, &vec![], &false);
    let mut norway = Country::new(<&str>::from("Norway"), &5500000, &100000, &vec![], &false);
    let mut denmark = Country::new(<&str>::from("Denmark"), &6000000, &50000, &vec![], &false);
